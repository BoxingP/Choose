...
public class HotelSystem {
    public static void main(String[] args) {
        ...
        Hotel lakewood = new Hotel(booking, new Price(110, 90, 80, 80));
        Hotel bridgewood = new Hotel(booking, new Price(160, 60, 110, 50));
        Hotel ridgewood = new Hotel(booking, new Price(220, 150, 100, 40));
